...
logistic_fit <- fit(logistic_mod,
                    trump ~ educ + age + party + ideology + income + gender + race,
                    data = cces)
logistic_fit %>%
  tidy(conf.int = TRUE) %>%
...
rf_mod <- rand_forest(mtry = 7, trees = 50) %>%
